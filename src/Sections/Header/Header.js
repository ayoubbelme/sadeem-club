            ...
            <nav className="bg-gray-200 border-gray-200 dark:bg-gray-900">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <a href="" className="flex items-center space-x-3 rtl:space-x-reverse">
                        <span className="self-center text-5xl text-primary whitespace-nowrap dark:text-white font-body">Sadeem</span>
                    </a>
                    <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                        <button type="button" className="text-primary hover:bg-primary font-medium rounded-3xl text-base px-4 py-2 text-center dark:bg-secondary dark:hover:bg-gray-900 dark:focus:ring-gray-900 border-solid border-2 border-primary hover:text-white transition"><a href='https://docs.google.com/forms/d/e/1FAIpQLSfoTSielykZ4IMgdFYVm0aifKSI9cc8RlIgEGpHuUpMvyUDgQ/viewform' target='_blank' className='bg-transparent'>انضم لنا</a></button>
                        <button 
                            onClick={toggleMenu}
                            type="button" 
                    ...
                    >
                        <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            <li>
                                <a href="#ContactUs" className="text-lg block py-2 px-3 md:p-0 text-gray-900 rounded hover:underline hover:bg-gray-100 md:hover:bg-transparent md:hover:text-primary md:dark:hover:text-primary dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">اتصل بنا</a>
                            </li>
                            <li>
